...
/** ScratchCompactionModes records the selectors used for one scratch compaction boundary. */
export interface ScratchCompactionModes {
	native: boolean;
	standard: boolean;
}
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	/** Scratch compaction selectors used for this boundary; absent on legacy and non-scratch entries. */
