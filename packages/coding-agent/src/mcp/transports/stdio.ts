...
export { terminateProcessTree as terminateStdioProcess };

import { hostHasInheritableConsole } from "../../launch/host-console";
import type {
	JsonRpcError,
	JsonRpcMessage,
	JsonRpcRequest,
...
export class StdioTransport implements MCPTransport {
	...
	async close(): Promise<void> {
		...
		if (this.#process) {
			...
			// `terminateProcessTree` for the exact signaling/escalation rules.
			await terminateProcessTree(proc, this.#detached);
		}
