...
3. Attempt cap — explicit max turns/tries (“stop after N attempts”).
...
After all 5 settled: call `goal` with `op: "create"` and the final objective. Objective MUST use this exact ordered markdown structure:
