...
7. **Respawn for substantial gaps; absorb trivial ones.** If a subagent returns materially incomplete or wrong work, spawn a corrective subagent with the specific gap. A trivial, self-contained fix that costs less to do than to describe stays with you (see rule 10).
