...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-coding-agent/async/durable-bash",
	...
	"@oh-my-pi/pi-coding-agent/cli/codex-home",
	...
	"@oh-my-pi/pi-coding-agent/session/boss-inbox",
	...
	"@oh-my-pi/pi-coding-agent/task/prompt-policy",
