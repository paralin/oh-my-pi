...
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "../../src/tools/browser/tab-protocol.js";
import { initializeTabWorkerForTest } from "../../src/tools/browser/tab-supervisor.js";
