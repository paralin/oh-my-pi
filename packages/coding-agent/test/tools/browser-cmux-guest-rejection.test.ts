...
const probe = `
import { CmuxTab, runCmuxCode } from "./packages/coding-agent/src/tools/browser/cmux/cmux-tab.js";
import { CmuxSocketClient } from "./packages/coding-agent/src/tools/browser/cmux/socket-client.js";
