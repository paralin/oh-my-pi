...
| `workflowz`   | Adds a deterministic multi-subagent workflow contract centered on the persistent IPython runtime and the typed `rlm` task APIs. It is intended for broad research, reviews, migrations, and adversarial coverage. |
