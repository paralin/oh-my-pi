...
language intelligence, debugging, web and GitHub access, remote connections,
MCP, memory, skills, rules, browser and computer control, cron, images,
security, Vibe workers, and World operations. `omp.capabilities()` returns the
