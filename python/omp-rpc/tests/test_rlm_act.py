...
"""Behavioral Act tests against the imported OMP kernel-side rlm module."""

from pathlib import Path
import sys

_REPO = Path(__file__).resolve().parents[3]
sys.path.insert(0, str(_REPO / "packages/coding-agent/src/ipython/python"))
...
try:
    ...
    async def test_task_cancellation_interrupts_act_and_restores_shell(self) -> None:
        ...
        shell.events.register("post_run_cell", post_results.append)
